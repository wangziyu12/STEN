...
#Evaluation scripts
python get_evaluation.py --load_path_stage_A runs/activity_val_trans3_T10 --load_path_stage_B runs/activity_all_trans3_T10  --dataset_name ActivityNet --AVCA
