...
#Evaluation scripts
python get_evaluation.py --load_path_stage_A runs/vgg_val_trans1_T2 --load_path_stage_B runs/vgg_all_trans1_T2  --dataset_name VGGSound --AVCA
