...
def get_model_params(lr, first_additional_triplet, second_additional_triplet,  reg_loss, additional_triplets_loss, dropout_encoder, dropout_decoder, additional_dropout, encoder_hidden_size, decoder_hidden_size, depth_transformer, momentum, T, scheduler, eta_min, epochs, use_bn, use_dropout):
    # Model parameters
    params_model = dict()
    ...
    params_model['T']=T
    params_model['scheduler']=scheduler
    params_model['eta_min']=eta_min
    params_model['epochs']=epochs
    params_model['use_bn']=use_bn
    params_model['use_dropout']=use_dropout 
    return params_model
